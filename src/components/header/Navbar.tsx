...
// -----------------------------------------------------------------------------
// Purpose:
// - Renders the navigation links for the app header.
//
// Features:
// - Displays links to home, about, menu, contact, etc.
// - Highlights the active route for better UX.
// - Integrates with i18n for localized navigation.
//
// Usage:
//   Used inside the Header component.
//
// Best Practices:
// - Keep navigation links in sync with app routes and i18n.
// - Use semantic HTML and accessible markup for navigation.
// -----------------------------------------------------------------------------
