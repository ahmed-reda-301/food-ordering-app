 ...
 * ----------------------
 * Renders a form for adding or editing products in the admin dashboard.
 ...
 * - Supports category selection, product options (sizes, extras), and image preview.
 *
 * Props:
 ...
 *
 * Usage:
 *   <Form translations={translations} categories={categories} product={product} />
 *
 * Best Practices:
