 ...
 * ---------------------
 * Renders UI for managing product options (sizes, extras) in the product form.
 * - Allows adding, editing, and removing sizes and extras for a product.
 * - Uses enums for available options and provides controls for each.
 * - i18n-ready: Uses translations prop for labels and messages.
 *
 * Props:
 *   - translations: Translations object for the current locale.
 *   - sizes: Array of size objects.
 *   - extras: Array of extra objects.
 *   - setSizes: State setter for sizes.
 *   - setExtras: State setter for extras.
 *
 * Usage:
 *   <ItemOptions translations={translations} sizes={sizes} extras={extras} setSizes={setSizes} setExtras={setExtras} />
 *
 * Best Practices:
 *   - Keep option logic modular and in sync with backend requirements.
