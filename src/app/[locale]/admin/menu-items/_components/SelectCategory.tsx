 ...
 * -----------------------
 * Renders a select dropdown for choosing a category when adding/editing a product.
 * - Displays all available categories and updates the selected category state.
 * - i18n-ready: Uses translations prop for label and options.
 *
 * Props:
 *   - categories: Array of category objects.
 *   - categoryId: Currently selected category ID.
 *   - setCategoryId: State setter for selected category ID.
 ...
 *
 * Best Practices:
 *   - Ensure all category options are up-to-date and translated.
 *   - Use this component in product forms for consistent category selection UI.
 */
