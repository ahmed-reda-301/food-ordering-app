// -----------------------------------------------------------------------------
// src/app/[locale]/auth/signup/_components/Form.tsx
//
// Signup Form Component
// -----------------------------------------------------------------------------
// Purpose:
// - Renders the registration form for new user sign up with localized content.
//
// Features:
// - Handles form submission and validation for user registration.
// - Displays dynamic form fields and error messages.
// - Shows loading state and disables submit button during registration.
// - Integrates with backend signup action for user creation.
// - Uses Sonner toast notifications for feedback (success/error).
//
// Usage:
//   <Form translations={translations} />
//   Used in the /[locale]/auth/signup page.
//
// Best Practices:
